    ...
    return(
        <div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center" id = "wrapper" onClick={handleClose}>
            <div className="md:w-[600px] sm:w-[500px] flex flex-col justify-center">
                ...
                <div className="bg-white p-2 rounded text-black grid grid-rows-2 justify-center ml-2 mr-2">
                    <h1 className="text-center mt-10">Apakah Anda yakin ingin keluar?</h1>
                    <div className="grid grid-cols-2 mt-10 justify-start mb-10">
